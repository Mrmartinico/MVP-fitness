...
class MyStats extends Component {
    ...
    imageFormatterRankPicture(cell, row){
            if(row != null && row.rank == 1){
                return (<div class="rankingcontainer">
                            <img class="rankingimage" src={rankingIcon} />
           ...
           <div className="app-container container">
            <div className="row">
                ...
                <div>
                    ...
                    <div className="row">
                        <div style={{borderRight: '1px solid #FFFFFF'}} className="col-xs-6 col-sm-6 col-md-4 col-lg-4 col-xl-4">
                        ...
                        <div style={{borderLeft: '1px solid #FFFFFF'}} className="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                            <div className="percentage-container">
                            ...
                            <div className="progress" style={{
                                ...
                                background: '#555', height: '22px', margin: '6px 60px'
                                    ...
                                    <div className="progress-bar custome-progress" role="progressbar"
                                        style={{width: 20 + '%', background: '#382CFB', boxShadow: '0px 4px 4px rgba(0, 0, 0, 0.25)'}}
                                        aria-valuenow={2}
