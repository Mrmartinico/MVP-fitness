...
class App extends React.Component {
  ...
  renderForms() {
    if (this.state.signUpPage === 0) {
      ...
      var active = 'btn btn-form global-btn';
      var inActive = 'btn btn-form global-btn borderd';
      return (
        <div>
          <div className="logo-wrap w-100">
            <img src={logoicon} alt="logo"/>
          ...
          <form className="form">
              ...
              <div className="col-5">
                <div className="form-group">
                  ...
                  <button type="button" onClick={this.handleActivity}
                          className={(this.state.activity.indexOf('Tennis') > -1) ? active : inActive}>Tennis
                  </button>
                  <button type="button" onClick={this.handleActivity}
                          className={(this.state.activity.indexOf('Yoga') > -1) ? active : inActive}>Yoga
                  </button>
                  <button type="button" onClick={this.handleActivity}
                          className={(this.state.activity.indexOf('Soccer') > -1) ? active : inActive}>Soccer
                  </button>
                  <button type="button" onClick={this.handleActivity}
                          className={(this.state.activity.indexOf('Crossfit') > -1) ? active : inActive}>Crossfit
                  </button>
                  <button type="button" onClick={this.handleActivity}
                          className={(this.state.activity.indexOf('Pilates') > -1) ? active : inActive}>Pilates
                  </button>
                  <button type="button" onClick={this.handleActivity}
                          className={(this.state.activity.indexOf('Running') > -1) ? active : inActive}>Running
                  </button>
                  <button type="button" onClick={this.handleActivity}
                          className={(this.state.activity.indexOf('Box') > -1) ? active : inActive}>Box
                  </button>
                  <button type="button" onClick={this.handleActivity}
                          className={(this.state.activity.indexOf('Golf') > -1) ? active : inActive}>Golf
                  </button>
                  <button type="button" onClick={this.handleActivity}
                          className={(this.state.activity.indexOf('Stretching') > -1) ? active : inActive}>Stretching
                  </button>
                </div>
                <div className="form-group">
            ...
            <div className="text-center">
              ...
              <button type="button" onClick={this.register} className="btn global-btn">register</button>
            </div>
          </form>
        </div>
      );
                  ...
                  {!this.state.loginStatus ?
                    <div>
                      <button type="button" className="btn global-btn mr-10" data-toggle="modal"
                              onClick={this.openSignUpModel} data-target="#myModal-signup">Sign Up
                      </button>
                      < button type="button" className="btn global-btn borderd" data-toggle="modal"
                               data-target="#myModal-signin">Sign In
                      </button>
                    </div>
